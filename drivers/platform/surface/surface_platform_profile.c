...
// Enum for the platform performance profile sent to the TMP .
...
// Enum for the fan performance profile sent to the FAN module if the 'has_fan'
// property is set. The integers are not a typo, they differ from the
